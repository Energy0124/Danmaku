    ...
    desktopStrings {
        when (language) {
            DesktopUiLanguage.ENGLISH -> {
                ...
                pairedLibraryServerRejectedError = "The library server rejected the request. Check the server URL and try again."
            ...
            DesktopUiLanguage.ZH_TW -> {
                ...
                pairedLibraryServerRejectedError = "媒體庫伺服器拒絕請求。請檢查伺服器 URL 後再試一次。"
