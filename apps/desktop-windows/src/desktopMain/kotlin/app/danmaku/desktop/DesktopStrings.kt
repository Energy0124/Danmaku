...
internal enum class DesktopUiLanguage(
    ...
    ENGLISH(
        ...
        stringsFactory = {
            ...
            playerIdleStatusLabel = "Idle"
            playerPausedStatusLabel = "Paused"
            playerEndedStatusLabel = "Ended"
            playerErrorStatusLabel = "Error"
            ...
            playAction = "Play"
            watchSummaryProgressLabel = { watched, watching, fresh ->
                "$watched watched, $watching watching, $fresh new"
            }
            ...
            localPlaybackLibraryNotIndexedError = "Index or scan a local library before preparing playback."
            ...
            localPlaybackNoDandanplayMatchError = "dandanplay did not find an anime match for this episode."
            localPlaybackPrepareFailedError = "Could not prepare local playback. Check the library file and try again."
            dandanplayLibraryNotIndexedSummary = "library is not indexed; cannot check danmaku"
            dandanplayPrepareFailedSummary = "prepare failed before danmaku could load"
            ...
            providerNotConfiguredStatus = "not configured"
            myAnimeListOauthTokenSavedStatus = "OAuth token saved"
            myAnimeListClientIdSecretSavedStatus = "client ID and secret saved"
            myAnimeListClientIdSearchSavedStatus = "client ID saved for anime search"
            bangumiAccessTokenSavedStatus = "access token saved"
            bangumiPublicSearchOnlyStatus = "public search only"
            dandanplayConfiguredStatus = { appId, authMode -> "configured for AppId $appId using $authMode" }
            dandanplayCompatibleApiStatus = "configured for compatible API server without credentials"
            dandanplayNotConfiguredStatus = "not configured for automatic fetching yet"
            externalSyncSummaryLabel = { updates, conflicts, skipped ->
                "$updates updates ready, $conflicts conflicts, $skipped skipped"
            }
            externalProgressAheadReason = "external progress is ahead of local progress"
            ...
            watchedEpisodeProgressLabel = { watched, total -> "$watched/$total watched" }
            ...
            noLinkLabel = "No link"
            missingLocalSeriesReason = "mapped series is no longer in the library"
            unmappedLocalSeriesReason = "series is not linked"
    ...
    ZH_TW(
        ...
        stringsFactory = {
            ...
            playerIdleStatusLabel = "閒置"
            playerPausedStatusLabel = "已暫停"
            playerEndedStatusLabel = "已結束"
            playerErrorStatusLabel = "錯誤"
            episodesSuffix = "集"
            ...
            playAction = "播放"
            watchSummaryProgressLabel = { watched, watching, fresh ->
                "$watched 已看，$watching 觀看中，$fresh 新增"
            }
            ...
            loadedNowLabel = "目前載入"
            localPlaybackLibraryNotIndexedError = "準備播放前，請先建立索引或掃描本機媒體庫。"
            ...
            localPlaybackNoDandanplayMatchError = "dandanplay 找不到此集的動畫對應。"
            localPlaybackPrepareFailedError = "無法準備本機播放。請檢查媒體庫檔案後再試一次。"
            dandanplayLibraryNotIndexedSummary = "媒體庫尚未索引；無法檢查彈幕"
            dandanplayPrepareFailedSummary = "準備失敗，尚未載入彈幕"
            ...
            providerNotConfiguredStatus = "尚未設定"
            myAnimeListOauthTokenSavedStatus = "已儲存 OAuth 權杖"
            myAnimeListClientIdSecretSavedStatus = "已儲存 client ID 與 secret"
            myAnimeListClientIdSearchSavedStatus = "已儲存 client ID，可用於動畫搜尋"
            bangumiAccessTokenSavedStatus = "已儲存 access token"
            bangumiPublicSearchOnlyStatus = "僅公開搜尋"
            dandanplayConfiguredStatus = { appId, authMode -> "已設定 AppId $appId，使用 $authMode" }
            dandanplayCompatibleApiStatus = "已設定相容 API 伺服器，未使用憑證"
            dandanplayNotConfiguredStatus = "尚未設定自動抓取"
            externalSyncSummaryLabel = { updates, conflicts, skipped ->
                "$updates 個更新可同步，$conflicts 個衝突，$skipped 個已略過"
            }
            externalProgressAheadReason = "外部進度領先本機進度"
            externalListWatchingStatus = "觀看中"
            externalListCompletedStatus = "已看完"
            externalListOnHoldStatus = "暫停觀看"
            externalListDroppedStatus = "已放棄"
            externalListPlanToWatchStatus = "計畫觀看"
            externalListUnchangedStatus = "不變"
            watchedEpisodeProgressLabel = { watched, total -> "已觀看 $watched/$total" }
            ...
            notLinkedLabel = "未連結"
            noLinkLabel = "無連結"
            missingLocalSeriesReason = "已對應系列不在媒體庫中"
            unmappedLocalSeriesReason = "系列尚未連結"
