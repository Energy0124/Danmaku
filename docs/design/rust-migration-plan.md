...
- `[x]` M5 packaging: the Rust-native portable builder produces a versioned
  runtime-free zip with `danmaku-player.exe`, the verified release-resolved libmpv DLL,
  ...
  libmpv API initialization, resolved hash validation, package shape, and an
